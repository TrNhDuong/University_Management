...
public:
    ...
    static bool isValidInstructYear(const int& instructYear);
    static bool isValidInstructYear(const string& instructYear, string & errorMsg);

    static bool isValidYearEnroll(const int& yearEnroll);
    static bool isValidYearEnroll(const string& yearEnroll, string & errorMsg);
};
